...
**תנאי סיום:**
- [x] קובץ migration SQL נוצר
- [x] בדיקה שמכניסים שיחה והודעות ב-DB
...
**תנאי סיום:**
- [x] אפשר לשמור FAQ **רק באישור בעלים** (Host)
...
**תנאי סיום:**
- [x] בעל צימר יכול לנהל שיחות **מקצה לקצה** מה-UI
...
**תנאי סיום:**
- [x] עובד מול **API אמיתי**, לא דמו
- [x] כל השלבים עובדים ברצף
...
| **Stage 5** | Agent Chat | 🟡 Partial | 30% |
| **Stage 6** | Host Console | 🟡 Partial | 20% |
| **Stage 7** | תשלומים | 🔴 Not started | 0% |
| **Stage 8** | הודעות | 🔴 Not started | 0% |
